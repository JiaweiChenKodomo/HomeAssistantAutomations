...
class TestEnergy(hass.Hass):
  ...
  setLevelLst = [25,51,76,102,127,153,178,204,229,255,229,204,178,153,127,102,76,51,25,0]
  ...
  def adjLevel(self, cb_args):
    ...
    if self.current_step < self.totalStep:
        ...
        self.turn_on("light.0x001788010d455ffd", brightness = setLevel)
        self.current_step += 1
    else:
