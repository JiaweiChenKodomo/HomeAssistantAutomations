...
$(function(){ //DOM Ready
    ...
    $(document).attr("title", "Hello2 Panel");
    ...
    var gridster = $(".gridster ul").gridster().data('gridster');
        ...
        gridster.add_widget('<li><div data-bind="attr: {style: widget_style}" class="widget widget-baseswitch-default-binary-sensor-presence-sensor-fp2-4a6e-presence-sensor-3" id="default-binary-sensor-presence-sensor-fp2-4a6e-presence-sensor-3"><span class="toggle-area" id="switch"></span><h1 class="title" data-bind="text: title, attr:{style: title_style}"></h1><h1 class="title2" data-bind="text: title2, attr:{style: title2_style}"></h1><h2 class="icon" data-bind="attr:{style: icon_style}"><i data-bind="attr: {class: icon}"></i></h2><h1 class="state_text" data-bind="text: state_text, attr: {style: state_text_style}"></h1></div></li>', 1, 1, 1, 4)
    ...
    // Initialize Widgets
        ...
        widgets["default-label"] = new basedisplay("default-label", "", "default", {'widget_type': 'basedisplay', 'fields': {'title': '', 'title2': '', 'value': 'Cubicle 2', 'unit': '', 'state_text': ''}, 'static_css': {'title_style': 'color: #fff;', 'title2_style': 'color: #fff;', 'unit_style': '', 'value_style': 'color: #fff;', 'state_text_style': 'color: #fff;', 'widget_style': 'background-color: #444;', 'container_style': ''}, 'css': {}, 'icons': [], 'static_icons': [], 'namespace': 'default'})
    
        widgets["default-illuminance-set-level"] = new baseslider("default-illuminance-set-level", "", "default", {'widget_type': 'baseslider', 'entity': 'input_number.illuminance_set_level2', 'post_service': {'service': 'input_number/set_value', 'entity_id': 'input_number.illuminance_set_level2'}, 'fields': {'title': 'Illuminance Set Level', 'title2': '', 'unit': '', 'level': ''}, 'icons': [], 'css': {}, 'static_icons': {'icon_up': 'fas-plus', 'icon_down': 'fas-minus'}, 'static_css': {'title_style': 'color: #fff;', 'title2_style': 'color: #fff;', 'level_style': 'color: #00aaff;', 'level_up_style': 'color: #888;', 'level_down_style': 'color: #888;', 'widget_style': 'background-color: #444;', 'unit_style': 'color: #00aaff;'}, 'namespace': 'default'})
    
        widgets["default-led2"] = new baselight("default-led2", "", "default", {'widget_type': 'baselight', 'entity': 'light.0x001788010d455ffd', 'post_service_active': {'service': 'homeassistant/turn_on', 'entity_id': 'light.0x001788010d455ffd'}, 'post_service_inactive': {'service': 'homeassistant/turn_off', 'entity_id': 'light.0x001788010d455ffd'}, 'fields': {'title': 'LED Level', 'title2': '', 'icon': '', 'units': '%', 'level': '', 'state_text': '', 'icon_style': ''}, 'icons': {'icon_on': 'fas-circle', 'icon_off': 'far-circle'}, 'static_icons': {'icon_up': 'fas-plus', 'icon_down': 'fas-minus'}, 'static_css': {'title_style': 'color: #fff;', 'title2_style': 'color: #fff;', 'state_text_style': 'color: #fff;', 'level_style': 'color: #fff;', 'unit_style': 'color: #fff;', 'level_up_style': 'color: #888;', 'level_down_style': 'color: #888;', 'widget_style': 'background-color: #444;'}, 'css': {'icon_style_active': 'color: #aaff00;', 'icon_style_inactive': 'color: #888;'}, 'namespace': 'default'})
    
        widgets["default-daylight-illuminance"] = new basedisplay("default-daylight-illuminance", "", "default", {'widget_type': 'basedisplay', 'entity': 'sensor.my_tcp_sensor2', 'entity_to_sub_entity_attribute': '', 'sub_entity': '', 'sub_entity_to_entity_attribute': '', 'fields': {'title': 'Daylight Illuminance', 'title2': '', 'value': '', 'unit': '', 'state_text': ''}, 'static_css': {'title_style': 'color: #fff;', 'title2_style': 'color: #fff;', 'state_text_style': 'color: #fff;font-size: 100%;', 'widget_style': 'background-color: #444;', 'container_style': ''}, 'css': {'value_style': 'color: #00aaff;font-size: 250%;', 'text_style': 'color: #fff;font-size: 100%;', 'unit_style': 'color: #00aaff;font-size: 100%;'}, 'icons': [], 'static_icons': [], 'units': 'lx', 'precision': 0.1, 'namespace': 'default'})
        ...
        widgets["default-binary-sensor-presence-sensor-fp2-4a6e-presence-sensor-3"] = new baseswitch("default-binary-sensor-presence-sensor-fp2-4a6e-presence-sensor-3", "", "default", {'widget_type': 'baseswitch', 'entity': 'binary_sensor.presence_sensor_fp2_4a6e_presence_sensor_3', 'state_active': 'on', 'state_inactive': 'off', 'fields': {'title': '', 'title2': '', 'icon': '', 'icon_style': '', 'state_text': ''}, 'icons': {'icon_on': 'fas-bullseye', 'icon_off': 'fas-minus'}, 'static_icons': [], 'css': {'icon_style_active': 'color: #ff0055;', 'icon_style_inactive': 'color: #888;'}, 'static_css': {'title_style': 'color: #fff;', 'title2_style': 'color: #fff;', 'state_text_style': 'color: #fff;', 'widget_style': 'background-color: #444;'}, 'title_is_friendly_name': 1, 'namespace': 'default'})
    
        widgets["default-automation-toggle"] = new baseswitch("default-automation-toggle", "", "default", {'widget_type': 'baseswitch', 'entity': 'input_boolean.useautomation2', 'state_active': 'on', 'state_inactive': 'off', 'enable': 1, 'post_service_active': {'service': 'homeassistant/turn_on', 'entity_id': 'input_boolean.useautomation2'}, 'post_service_inactive': {'service': 'homeassistant/turn_off', 'entity_id': 'input_boolean.useautomation2'}, 'fields': {'title': 'Automatically Control Light', 'title2': '', 'icon': '', 'icon_style': '', 'state_text': ''}, 'icons': {'icon_on': 'fas-sliders-h', 'icon_off': 'fas-sliders-h'}, 'static_icons': [], 'css': {'icon_style_active': 'color: #aaff00;', 'icon_style_inactive': 'color: #888;'}, 'static_css': {'title_style': 'color: #fff;', 'title2_style': 'color: #fff;', 'state_text_style': 'color: #fff;', 'widget_style': 'background-color: #444;'}, 'namespace': 'default'})
    ...
    window.dashstream = new DashStream("ws", location.protocol, document.domain, location.port, "Hello2 Panel", widgets);
